...
if(
	isset($_POST["custom_insurance_company"]) AND !empty($_POST["custom_insurance_company"]) AND isset($_POST["custom_insurance_company_name"]) AND 
	!empty($_POST["custom_insurance_company_name"])
) {
	$_POST["insurance_company_id"] = NULL;
} else {
