<?php if(isset($product_full_data)) { //echo "<pre>";print_r($product_full_data);echo "</pre>"; ?>
<div id="box" class="row bg-main-gradient rounded-4 shadow-sm px-md-4 px-2 pt-md-4 pt-2 pb-md-3 pb-2 mb-3">
	<div class="col collapsed" data-bs-toggle="collapse" data-bs-target="#your-box-products" aria-expanded="false" aria-controls="your-box-products">
		<div class="row mb-md-2 mb-0">
			<div class="col px-2">
				<h5 class="mb-0 text-white">Ihre <?php echo $company["servicename"] ?></h5>
	...
	<div id="your-box-products" class="col-12 mt-1 mb-2 collapse show">
		...
		<div class="row bg-white py-2 mt-md-4 mt-1 mb-2 shadow-sm border rounded selected-product">
			<div class="col-auto d-md-block d-none">
				<img src="<?php echo BASEHREF ?>img/products/99.png" border="0" alt="" style="max-height:50px">
			</div>
			<div class="col">
				<div class="row g-0">
					<div class="col-12 product-name">
		...
		<a class="custom-btn <?php echo BTN_GRADIENT ?> w-100" href="<?php echo BASEHREF ?>auswahl/<?php echo $admin_url_addition ?>">Ihre Auswahl ändern</a>
		<?php } ?>
	</div>
</div>
<?php } ?>
