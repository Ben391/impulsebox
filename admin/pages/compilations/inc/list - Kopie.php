			...
			<div class="row">
				...
				<div class="col-12">
					<div class="compilation-content mb-3">
						<?php foreach($compilation["products_readable"] as $product_readable) { ?>
					...
					<button class="custom-btn toggle-active <?php echo ($compilation["active"] == 1) ? 'custom-btn-outline-primary' : 'custom-btn-outline-danger'; ?>" data-compilation-id="<?php echo $compilation["id"]; ?>" data-active="<?php echo $compilation["active"]; ?>">
