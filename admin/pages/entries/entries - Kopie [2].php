<div class="container py-4">
	<div class="row">
		...
		<div class="col py-3">
			...
			$totalEntries = getTotalEntries($mysqli, $where);
			$entriesPerPage = 20;
			...
			echo getEntries($mysqli, $where, $entriesPerPage, $offset, $keyword, true);
			
			
			if($entries = getEntries($mysqli, $where, $entriesPerPage, $offset, $keyword)) {
			...
			<table class="table table-hover table-bordered table-responsive ftsz-1">
				...
				foreach($entries AS $e) { 
					...
					?>
					<tr class="<?php if($entry_status > 0) echo "table-warning "; ?>">
